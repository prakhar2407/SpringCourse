...
/*
 * public Customer(List<String> names,Set<Long> Phno,Map<Long, String>
 * aadharNo,Properties email) { this.names=names; this.Phno=Phno;
 * this.aadharNo=aadharNo; this.setEmail(email); }
 */
